...
def test_monitor_service():
    ...
    dummy_service = MonitorService(1234, "dummy_service", service_name="My Dummy Service")
    ...
    assert dummy_service_dict["service_name"] == "My Dummy Service"
    assert dummy_service_dict["service_type"] == "dummy_service"


"""
Will Move test_monitor_port.py
...
def test_monitor_http_success():
    ...
    http_monitor = MonitorHTTP("http://raspi3.mobieus.org:3333", service_name="My Gitea server", service_port=3333)
...
def test_monitor_http_failed():
    ...
    http_monitor = MonitorHTTP("http://raspi3.mobieus.org:3334", service_name="My Gitea server", service_port=3334)
    http_monitor_status = http_monitor.get_status()
